      ...
      <section className="cover">
        <div className="content">
          <section className="top">
            ...
            <p className="title animate_animated animate__fadeInUp">
              the wedding of
            </p>
            <p className="name animate_animated animate__fadeInUp">
              Nailal and Via
            </p>
          </section>
...
// /template-nailalvia/static/bg-sound-946cc5b0fbb9759746fce004461e52cc.mp3
// b4c5d5
